...
const ToggleAI = ({
  ...
  const { activeFileId, editorContent, updateFileContent } = useFileExplorer();
  ...
  const activeFile = { name: activeFileId?.split("/").pop(), content: editorContent || "" };
  ...
  return (
    <>
      ...
      <AIChatSidePanel
        ...
        activeFileId={activeFileId as string | undefined}
