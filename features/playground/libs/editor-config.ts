...
export const defaultEditorOptions = {
  ...
  minimap: { 
    enabled: true,
    size: "proportional" as "proportional",
    showSlider: "mouseover" as "mouseover"
  },
  ...
  foldingStrategy: "indentation" as "indentation",
  showFoldingControls: "mouseover" as "mouseover",
  ...
  // Selection
  multiCursorModifier: "ctrlCmd" as "ctrlCmd",
  selectionHighlight: true,
  occurrencesHighlight: "singleFile" as "singleFile",
  
  // Suggestions
  suggestOnTriggerCharacters: true,
  acceptSuggestionOnEnter: "on" as "on",
  tabCompletion: "on" as "on",
  wordBasedSuggestions: "currentDocument" as "currentDocument",
  quickSuggestions: {
    other: true,
    comments: false,
    strings: false
  ...
  find: {
    ...
    seedSearchStringFromSelection: "always" as "always"
  },
